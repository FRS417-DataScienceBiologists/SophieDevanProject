...
parks_renamed %>%
  ...
  group_by(park_name) %>%
   summarize(mean_rec_visits = mean(rec_visits), 
              ...
              total = n()) %>%
  arrange(desc(mean_rec_visits)) %>%
  ggplot(aes(x=reorder(park_name, mean_rec_visits), y=mean_rec_visits, fill=park_name)) +
  geom_bar(stat="identity") +
  labs(title = "Rec Visits Per Park",
       x = "Park",
       y = "Rec Visits") +
  theme(legend.position = "none", axis.text.x = element_text(angle = 65, hjust = 1),
       plot.title=element_text(size=16, face="bold", hjust=0.5),
...
parks_renamed %>%
  ...
  geom_point() +
  geom_line() +
  labs(title = "Visits to Kobuk Valley NP Overtime",
       x = "Year",
       y = "Mean Rec Visits") +
...
parks_renamed %>%
  ...
  geom_point() +
  geom_line() +
  labs(title = "Visits to Great Smoky Mountains Overtime",
       x = "Year",
       y = "Mean Rec Visits") +
  theme(plot.title=element_text(size=16, face="bold", hjust=0.5),
        axis.text = element_text(size=10),
...
parks_renamed %>%
  ...
  geom_point() +
  geom_line() +
  labs(title = "Visits to Grand Canyon NP Overtime",
       x = "Year",
       y = "Mean Rec Visits") +
  theme(plot.title=element_text(size=16, face="bold", hjust=0.5),
        axis.text = element_text(size=10),
...
parks_renamed %>%
  ...
  geom_point() +
  geom_line() +
  labs(title = "Visits to Yosemite NP Overtime",
       x = "Year",
       y = "Mean Rec Visits") +
  theme(plot.title=element_text(size=16, face="bold", hjust=0.5),
        axis.text = element_text(size=10),
...
parks_renamed %>%
  ...
  geom_point() +
  geom_line() +
  labs(title = "Visits to Yellowstone NP Overtime",
       x = "Year",
       y = "Mean Rec Visits") +
  theme(plot.title=element_text(size=16, face="bold", hjust=0.5),
        axis.text = element_text(size=10),
...
parks_renamed %>%
  ...
  geom_point() +
  geom_line() +
  labs(title = "Visits to Olympic NP Overtime",
       x = "Year",
       y = "Mean Rec Visits") +
  theme(plot.title=element_text(size=16, face="bold", hjust=0.5),
        axis.text = element_text(size=10),
